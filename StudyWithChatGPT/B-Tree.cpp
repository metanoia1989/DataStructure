...
public:
  ...
  // A function to get the predecessor of the key- where the key is present
  ...
  // A function to fill up the child node present in the idx-th position
...
// A function to return the index of the first key that is greater
// or equal to k
...
// A function to remove the key k in subtree rooted with this node
void BTreeNode::remove(int k)
{
  ...
  else
  {
    ...
    // The key to be removed is not present in this node
    ...
    // If the last key of the child is less than the key to be removed, we
...
int BTree::getMinKeyCount() { return (root == NULL) ? 0 : root->minKeyCount(); }
